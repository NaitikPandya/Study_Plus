              ...
              child: Column(
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: Text("${(index+1).toString()} / $aTask ",style: TextStyle(fontSize: 20.0),),
                  ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: (){
                          ansCheck(snapshot.data.documents[index].data["${_option[0]}"],1);
                        },
                        child: Container(
                          ...
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(snapshot.data.documents[index].data["${_option[0]}"],style: TextStyle(color: Colors.white),),
                          ),
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          ansCheck(snapshot.data.documents[index].data["${_option[1]}"],2);
                        },
                        child: Container(
                          margin: EdgeInsets.only(left: 20.0,right: 20.0),
                          height: 40.0,
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(snapshot.data.documents[index].data["${_option[1]}"],style: TextStyle(color: Colors.white),),
                          ),
                          decoration: BoxDecoration(
                              color:btn[2],
                              borderRadius: BorderRadius.circular(30.0)
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          ansCheck(snapshot.data.documents[index].data["${_option[2]}"],3);
                        },
                        child: Container(
                          margin: EdgeInsets.only(left: 20.0,right: 20.0),
                          height: 40.0,
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(snapshot.data.documents[index].data["${_option[2]}"],style: TextStyle(color: Colors.white),),
                          ),
                          decoration: BoxDecoration(
                              color:btn[3],
                              borderRadius: BorderRadius.circular(30.0)
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          ansCheck(snapshot.data.documents[index].data["${_option[3]}"],4);
                        },
                        child: Container(
                          margin: EdgeInsets.only(left: 20.0,right: 20.0),
                          height: 40.0,
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(snapshot.data.documents[index].data["${_option[3]}"],style: TextStyle(color: Colors.white),),
                          ),
                          decoration: BoxDecoration(
                              color:btn[4],
                              borderRadius: BorderRadius.circular(30.0)
